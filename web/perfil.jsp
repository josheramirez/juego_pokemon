    ...
    <body bgcolor="#f0f0fd">
        ...
        <div id="personaje" align="left" style="background-color:skyblue; width:25%;">
            ...
            <div style="position: relative" >
                      <div id="genero" class='charDiv'><img class='charPhoto' src='pic/<%=genero%>.png'></div>
                      <div class='charDiv'><img class='charPhoto' src='pic/<%=genero%>/raza/<%=raza%>.png'></div>
                                <div class='charDiv'><img class='charPhoto' src='pic/<%=genero%>/equipo/<%=equipo%>.png'></div>
                               <div class='charDiv'><img class='charPhoto' src='pic/<%=genero%>/colorOjos/<%=colorOjos%>.png'></div>
                               <div class='charDiv'><img class='charPhoto' src='pic/<%=genero%>/colorPelo/<%=colorPelo%>.png'></div>
