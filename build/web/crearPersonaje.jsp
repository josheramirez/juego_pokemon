				...
				<form action="crearPersonaje" method="get" id="CrearPersonaje">
					<fieldset>
						<legend>Crear personaje</legend>
                                                <%= usuario.nombre%>
						<input name="usuario_id" type="hidden" value="<%= usuario.id%>" readonly>
						<hr><div style="height: 10px"></div>
						<input type="text" name="nombre" id="nombre" required placeholder="Nombre de personaje"><div style="height: 10px"></div>
